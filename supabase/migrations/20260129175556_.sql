-- Fix notify_group_added trigger to work when added_by is NULL
-- When NULL, look up the group creator as the "adder"
...
BEGIN
  ...
  VALUES (
    ...
    jsonb_build_object(
      ...
      'added_by_id', v_adder_id,
      'added_by_name', COALESCE(v_adder_name, 'Someone')
    )
  );
