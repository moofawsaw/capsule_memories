...
/**
 * CustomAboutSettings - About app card with version info and legal links
 */
class CustomAboutSettings extends StatelessWidget {
  const CustomAboutSettings({
    Key? key,
    this.headerIcon,
    this.headerTitle,
    this.appVersion,
  ...
  final List<CustomAboutOption>? aboutOptions;
